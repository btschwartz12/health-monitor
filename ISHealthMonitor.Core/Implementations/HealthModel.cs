            ...
            foreach (var site in allSites)
            {
				...
				else if (creationEnabled && site.SSLExpirationDate < thresholdDate)
				{
                    WorkOrderDTO model = new WorkOrderDTO()
                    {
                        ...
                        Urgency = "2",
                        Description = $"The SSL Certificate is going to expire on: {site.SSLExpirationDate}.\nURL: {site.URL}\nPLEASE NOTE: this work order was automatically generated by healthmonitor.hyland.com"
                    };
